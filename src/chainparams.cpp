...
class CMainParams : public CChainParams
{
  public:
    CMainParams()
    {
        ...
        const char *pszTimestamp = "This one is NoderX";
...
//       printf("genesis.GetHash = %s\n", genesis.GetHash().ToString().c_str());
  //   printf("merkle = %s\n", genesis.hashMerkleRoot.ToString().c_str());
        ...
        assert(hashGenesisBlock == uint256("0x3624000403ba4794fcce0388ba4571858f495409731dd16f32c5c042ea9cbdeb"));
        assert(genesis.hashMerkleRoot == uint256("0x12e61ab549f264edd7401963554ed1c9cb1616c13e2736281760432872a10996"));

        vSeeds.push_back(CDNSSeedData("n0", "104.207.129.122"));
        vSeeds.push_back(CDNSSeedData("n1", "45.77.78.72")); 

...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeNoderxAmount"))
        settings.setValue("nAnonymizeNoderxAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeNoderxAmount = settings.value("nAnonymizeNoderxAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeNoderxAmount"))
        SoftSetArg("-anonymizeNoderxamount", settings.value("nAnonymizeNoderxAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeNoderxAmount:
            nAnonymizeNoderxAmount = value.toInt();
            settings.setValue("nAnonymizeNoderxAmount", nAnonymizeNoderxAmount);
            emit anonymizeNoderxAmountChanged(nAnonymizeNoderxAmount);
            break;
        default:
            break;
        }
